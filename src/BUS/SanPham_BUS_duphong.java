...
////                return false;
////            } Tạm thời bỏ logic kệ trong BUS
//
...
////        }
////        return null;
////    } không để SanPham_BUS biết sản phẩm nằm ở kệ nào
//
...
//            if (tongHienTai + sp.getSoLuong() > ke.getSucChua()) {
//                return "Kệ " + ke.getMaKe() + " không đủ sức chứa!";
//            }
//        }
//
//        // 1. Thêm vào SAN_PHAM (không cần số lượng)
//        if(spDAO.insert(sp)) {
//            // 2. Thêm vào CHITIET_KE (số lượng ở đây)
//            new ChiTietKe_DAO().insertOrUpdate(
//                    new ChiTietKe(
//                            sp.getMaKe(),
//                            sp.getMaSP(),
//                            sp.getSoLuong()  // số lượng chỉ lưu ở đây
//                    )
//            );
//            listSP.add(sp);
...
//        if (ke != null) {
//            int tongHienTai = kkBUS.tinhTongSoLuongTheoKe(ke.getMaKe());
//            SanPham spCu = getSanPhamByMa(sp.getMaSP());
//            if (spCu != null && spCu.getMaKe().equals(sp.getMaKe())) {
//                tongHienTai -= spCu.getSoLuong();
//            }
//            if (tongHienTai + sp.getSoLuong() > ke.getSucChua()) {
//                return "Kệ " + ke.getMaKe() + " không đủ sức chứa!";
//            }
//        }
//
//        // 1. Cập nhật SAN_PHAM (không cập nhật số lượng)
//        if (spDAO.update(sp)) {
//            // 2. Cập nhật CHITIET_KE (số lượng)
//            new ChiTietKe_DAO().insertOrUpdate(
//                    new ChiTietKe(
//                            sp.getMaKe(),
//                            sp.getMaSP(),
