...
public class PhieuNhap_GUI extends JPanel {
    ...
    private JPanel pnlCode_PhieuNhap;
    ...
    public void Initcomponents(){
        ...
        pnlCode_PhieuNhap = new JPanel(new BorderLayout());
        pnlCode_PhieuNhap.setBorder(new EmptyBorder(20, 20, 20, 20));

        ThanhTimKiem();

        pnlCode_PhieuNhap.add(pnlTop, BorderLayout.NORTH);
    ...
    public void ThanhTimKiem(){
        ...
        String[] listNCC = {"Tên nhà cung cấp", "ncc1" , "ncc2", "ncc3", "ncc4", "ncc5"};
        JComboBox<String> cbTenNCC = new JComboBox<>(listNCC);

        cbTenNCC.setBackground(new Color(204, 227, 253));
        cbTenNCC.setPreferredSize(new Dimension(cbTenNCC.getPreferredSize().width + 10,35));
        cbTenNCC.setBorder(this.lineBorder);
        ((JLabel) cbTenNCC.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);

        //Add comboBox tên ncc vào pnlTimKiem
        pnlTimKiem.add(cbTenNCC);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            PhieuNhap_GUI phieuNhapPanel = new PhieuNhap_GUI();

            // Thêm panel vào frame
            frame.add(phieuNhapPanel);
