...
//        soDoKe = new JPanel(new GridBagLayout());
...
//            gbc.gridy = row;
//
//            soDoKe.add(taoTheKe(ke.getMaKe(), percent), gbc);
//
//            col++;
//
//            if(col == 5){
...
//
//            switch (value) {
//                case "< 50%": match = percent < 50; break;
//                case "50 - 80%": match = percent >=50 && percent <=80; break;
//                case "> 80%": match = percent > 80; break;
//                default: match = true;
//            }
//
//            if(match){
