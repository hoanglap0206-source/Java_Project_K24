...
//
//        // 2. Kiểm tra trống và Request Focus
//        if (ma.isEmpty()) {
//            JOptionPane.showMessageDialog(this, "Vui lòng nhập Mã nhà cung cấp!");
//            txtMa.requestFocus(); // Focus vào ô Mã
//            return;
//        }
//
//        if (ten.isEmpty()) {
//            JOptionPane.showMessageDialog(this, "Vui lòng nhập Tên nhà cung cấp!");
//            txtTen.requestFocus(); // Focus vào ô Tên
//            return;
//        }
//
//        // Bạn có thể thêm kiểm tra cho SDT hoặc Địa chỉ nếu muốn
//        if (sdt.isEmpty()) {
